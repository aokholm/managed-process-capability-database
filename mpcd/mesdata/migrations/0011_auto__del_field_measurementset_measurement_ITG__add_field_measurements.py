...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MeasurementSet.measurement_ITG'
        db.delete_column(u'mesdata_measurementset', 'measurement_ITG')

        # Adding field 'MeasurementSet.measurement_itg'
        db.add_column(u'mesdata_measurementset', 'measurement_itg',
    ...
    models = {
        ...
        u'mesdata.measurementset': {
            ...
            'generaltag': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'measurement_sets'", 'symmetrical': 'False', 'to': u"orm['tags.GeneralTag']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
