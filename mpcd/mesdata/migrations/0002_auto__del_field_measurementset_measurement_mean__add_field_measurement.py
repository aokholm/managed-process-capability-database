...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MeasurementSet.measurement_bias'
        db.add_column(u'mesdata_measurementset', 'measurement_bias',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MeasurementSet.measurement_bias'
        db.delete_column(u'mesdata_measurementset', 'measurement_bias')
