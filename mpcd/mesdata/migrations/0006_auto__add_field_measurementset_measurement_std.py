...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeasurementSet.measurement_std'
        db.add_column(u'mesdata_measurementset', 'measurement_std',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeasurementSet.measurement_std'
        db.delete_column(u'mesdata_measurementset', 'measurement_std')
